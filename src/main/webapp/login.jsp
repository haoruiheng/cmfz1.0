...
<head>
	...
	<script type="text/javascript">
		//点击更换验证码：
		function chgImg(obj){
				obj.src="${pageContext.request.contextPath}/img/createImg.do?xxx="+Math.random();
		}
	</script>
</head>
<body>
		...
		<div class="login">
			<form id="loginForm" action="${pageContext.request.contextPath}/adminController/login.do" method="post" >
					  ...
					  <tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" onclick="chgImg(this)" src="${pageContext.request.contextPath}/img/createImg.do"/>
							</td>
						</tr>					
					<tr>
						<td>
